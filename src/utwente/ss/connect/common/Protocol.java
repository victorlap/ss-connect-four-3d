 ...
 *          Changelog:
 * 
 *          v1.0.4: Added option for a draw in: -gameover -leaderboard
 * 
 *          v1.0.3: Deleted whisper commands
 * 
 *          v1.0.2: Added standart port number Made all strings "public static
 *          final" (just to be sure that you cannot override them) Added example
 *          to the challengelist command Added commands for whisper messages
 * 
...
public interface Protocol {
	 ...
	 * 
	 * Arguments: - name = Name of the client that won the game. If name ==
	 * "null", then the game was a draw.
	 * 
	 ...
	 * Draw
	 *
	 * code: "gameover" Direction: Server -> Client
	 */
	 ...
	 * Direction: Server -> Client
	 * 
	 * Example: Niek request the challenge list. victor, steen and arthur
	 * support the feature
	 * 
	...
	/**
	 * Used to send the data of the game to the leaderboard. Can be ignored if
	 * the server saves the data to the leaderboard.
	 * 
	 * Arguments: - name = Name of the player - score = The score of the game -
	 * time = date and time when the game was played
	 * 
	 * Requirements for arguments: - score = 0 || 1 || 3 0 = loss 1 = draw 3 =
	 * win (also the client that disconnects, loses the game) - time = UNIX
	 * Timestamp
	 * 
	 ...
	 * 
	 * Example: There are 2 entries in the leaderbaord. 1 draw and 1 game that I
	 * lost
	 * 
